 ...
 */
public class VisionQuestions extends SuperQuestions{

    private static final String QUESTION_ONE = "Which eye do you experience symptoms in?";
    private static  final ArrayList<String> QUESTION_ONE_ANSWER_SELECTIONS = new ArrayList<>(Arrays.asList("R", "L", "Both"));

    private static final String QUESTION_TWO = "Are you legally blind?";
    private static  final ArrayList<String> QUESTION_TWO_ANSWER_SELECTIONS = new ArrayList<>(Arrays.asList("Yes", "No"));

    public VisionQuestions(Context context) {
        super(context);
        loadQuestions();
    }
