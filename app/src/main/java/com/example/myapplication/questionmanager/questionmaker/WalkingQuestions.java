 ...
 */
public class WalkingQuestions extends SuperQuestions{

    private static final String QUESTION_ONE = "Which leg do you experience symptoms in?";
    private static  final ArrayList<String> QUESTION_ONE_ANSWER_SELECTIONS = new ArrayList<>(Arrays.asList("R", "L", "Both"));

    private static final String QUESTION_TWO = "Are you able to walk short distances?";
    private static  final ArrayList<String> QUESTION_TWO_ANSWER_SELECTIONS = new ArrayList<>(Arrays.asList("Yes", "No"));

    public WalkingQuestions(Context context) {
        super(context);
        loadQuestions();
    }
